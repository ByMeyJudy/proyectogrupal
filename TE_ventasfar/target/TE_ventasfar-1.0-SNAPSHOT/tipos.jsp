<%-- 
    Document   : tipos
    Created on : 27 nov. 2021, 19:23:46
    Author     : WINDOWS 10
--%>
<%
...
<body>
    <div class="container">
        ...
        <br>   
        <a href="TipoControlador?action=add" class="btn btn-primary btn-sm"><i class="fas fa-plus-circle"></i> Nuevo Registro</a>
            ...
            <tbody>
                <c:forEach var="item" items="${tipos}">
                    <tr>
                        ...
                        <td><a href="TipoControlador?action=edit&id=${item.id}" class="btn btn-warning">Editar</a></td>
                        <td><a href="TipoControlador?action=delete&id=${item.id}" onclick="return(confirm('¿Esta seguro de eliminar el registro seleccionado?'))" class="btn btn-danger">Eliminar</a>
                        </td>
                    </tr>                    
                </c:forEach>
            </tbody>
